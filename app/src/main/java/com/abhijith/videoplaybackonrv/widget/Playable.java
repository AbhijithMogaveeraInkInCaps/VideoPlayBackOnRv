...
public interface Playable extends PlayabilityStateChangeObserver {
    ...
    /**
     * Releases the {@link com.abhijith.videoplaybackonrv.player.Player} associated with this item.
     ...
     * (Tags are used to help to differentiate the {@link com.abhijith.videoplaybackonrv.player.Player}s within the Player Pool,
     ...
     * for the internal management of the {@link com.abhijith.videoplaybackonrv.player.Player} instances.
     * (override the {@link #getTag()} in cases when you need to prevent the sharing of the {@link com.abhijith.videoplaybackonrv.player.Player}
    ...
    /**
     * The {@link com.abhijith.videoplaybackonrv.player.Player} configuration.
    ...
    /**
     * Determines whether the current item can manage the {@link com.abhijith.videoplaybackonrv.player.Player}'s
